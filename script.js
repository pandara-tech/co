...
const lang = {
  en: {
    ...
    'product-2-badge': 'In development', 'product-2-desc': 'Integrated word processor that lets you edit, create, and format text documents with ease. Supports multiple formats.',
  ...
  ar: {
    ...
    'product-2-badge': 'قيد التطوير', 'product-2-desc': 'معالج نصوص متكامل يتيح لك تحرير المستندات النصية وإنشائها وتنسيقها بسهولة. يدعم تنسيقات متعددة.', 'product-2-action': 'تحميل',
    'product-3-badge': 'قيد التطوير', 'product-3-desc': 'تطبيق جداول بيانات احترافي لتحليل البيانات، إجراء الحسابات، وإنشاء التقارير.',
    'product-4-badge': 'قيد التطوير', 'product-4-desc': 'أداة ذكية لتحويل الملفات إلى صور بجودة عالية. يدعم المستندات والعروض والجداول.',
